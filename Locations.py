...
strawberry_location_data_table: Dict[str, AstronautilusLocationData] = {
    LocationName.strawberry_1:  AstronautilusLocationData(RegionName.intro_islands,        astronautilus_base_id + 0x00),
    LocationName.strawberry_2:  AstronautilusLocationData(RegionName.granny_island,        astronautilus_base_id + 0x01),
    LocationName.strawberry_3:  AstronautilusLocationData(RegionName.granny_island,        astronautilus_base_id + 0x02),
    LocationName.strawberry_4:  AstronautilusLocationData(RegionName.granny_island,        astronautilus_base_id + 0x03),
    LocationName.strawberry_5:  AstronautilusLocationData(RegionName.granny_island,        astronautilus_base_id + 0x04),
    LocationName.strawberry_6:  AstronautilusLocationData(RegionName.highway_island,       astronautilus_base_id + 0x05),
    LocationName.strawberry_7:  AstronautilusLocationData(RegionName.highway_island,       astronautilus_base_id + 0x06),
    LocationName.strawberry_8:  AstronautilusLocationData(RegionName.nw_girders_island,    astronautilus_base_id + 0x07),
    LocationName.strawberry_9:  AstronautilusLocationData(RegionName.granny_island,        astronautilus_base_id + 0x08),
    LocationName.strawberry_10: AstronautilusLocationData(RegionName.granny_island,        astronautilus_base_id + 0x09),
    LocationName.strawberry_11: AstronautilusLocationData(RegionName.highway_island,       astronautilus_base_id + 0x0A),
    LocationName.strawberry_12: AstronautilusLocationData(RegionName.badeline_tower_lower, astronautilus_base_id + 0x0B),
    LocationName.strawberry_13: AstronautilusLocationData(RegionName.highway_island,       astronautilus_base_id + 0x0C),
    LocationName.strawberry_14: AstronautilusLocationData(RegionName.ne_feathers_island,   astronautilus_base_id + 0x0D),
    LocationName.strawberry_15: AstronautilusLocationData(RegionName.ne_feathers_island,   astronautilus_base_id + 0x0E),
    LocationName.strawberry_16: AstronautilusLocationData(RegionName.ne_feathers_island,   astronautilus_base_id + 0x0F),
    LocationName.strawberry_17: AstronautilusLocationData(RegionName.se_house_island,      astronautilus_base_id + 0x10),
    LocationName.strawberry_18: AstronautilusLocationData(RegionName.se_house_island,      astronautilus_base_id + 0x11),
    LocationName.strawberry_19: AstronautilusLocationData(RegionName.se_house_island,      astronautilus_base_id + 0x12),
    LocationName.strawberry_20: AstronautilusLocationData(RegionName.badeline_tower_lower, astronautilus_base_id + 0x13),
    LocationName.strawberry_21: AstronautilusLocationData(RegionName.cassette_1,           astronautilus_base_id + 0x14),
    LocationName.strawberry_22: AstronautilusLocationData(RegionName.cassette_2,           astronautilus_base_id + 0x15),
    LocationName.strawberry_23: AstronautilusLocationData(RegionName.cassette_3,           astronautilus_base_id + 0x16),
    LocationName.strawberry_24: AstronautilusLocationData(RegionName.cassette_4,           astronautilus_base_id + 0x17),
    LocationName.strawberry_25: AstronautilusLocationData(RegionName.cassette_5,           astronautilus_base_id + 0x18),
    LocationName.strawberry_26: AstronautilusLocationData(RegionName.cassette_6,           astronautilus_base_id + 0x19),
    LocationName.strawberry_27: AstronautilusLocationData(RegionName.cassette_7,           astronautilus_base_id + 0x1A),
    LocationName.strawberry_28: AstronautilusLocationData(RegionName.cassette_8,           astronautilus_base_id + 0x1B),
    LocationName.strawberry_29: AstronautilusLocationData(RegionName.cassette_9,           astronautilus_base_id + 0x1C),
    LocationName.strawberry_30: AstronautilusLocationData(RegionName.cassette_10,          astronautilus_base_id + 0x1D),
}
